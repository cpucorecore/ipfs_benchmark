...
# cluster pin rm
./ipfs_benchmark --from 0 --to 100 -g 1 --sc=true api --host 127.0.0.1 -p 9094 -d=false --tag crdt cluster pin --tr tests/report/cluster_add_g10_sc-true_from0_to100_bs1048576_replica3_pin-true_crdt.json rm

# cluster pin add
./ipfs_benchmark --from 0 --to 100 -g 1 --sc=true api --host 127.0.0.1 -p 9094 -d=false --tag crdt cluster pin --tr tests/report/cluster_add_g10_sc-true_from0_to100_bs1048576_replica3_pin-true_crdt.json add -r 3
